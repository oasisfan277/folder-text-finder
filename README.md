...
Press Enter on a selected result to open the extracted document text at the exact match. The result window also offers an Open File button for opening the original file in its default application.
