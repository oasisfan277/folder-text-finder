...
Results include the file name, full path, location, matching text preview, and page number when reliable page information is available. Text files use line and column. Word-style documents use paragraph and column because Word visual line numbers do not match extracted text.
